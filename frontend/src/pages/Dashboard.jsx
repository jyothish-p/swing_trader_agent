        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
          <div className="max-w-4xl">
            ...
            <p className="text-base text-slate-300">
              Top NSE stocks scored equally by TITAN v20, TITAN v19, Swing AI v12.2, Swing AI v12.1, KING v16 and Backtest Engine.
            </p>
            <p className="mt-3 text-sm text-slate-500">
              Full 6-engine scoring, live quotes and run snapshots in one dark terminal-style workspace.
            </p>
          </div>
