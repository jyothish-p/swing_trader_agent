...
MATE_PRO_MAX_SYMBOLS = max(0, int(os.getenv("MATE_PRO_MAX_SYMBOLS", "40")))
MATE_PRO_RESULT_HYDRATION_LIMIT = max(0, int(os.getenv("MATE_PRO_RESULT_HYDRATION_LIMIT", "0")))
SCREENER_STALE_RUN_MINUTES = int(os.getenv("SCREENER_STALE_RUN_MINUTES", "60"))
